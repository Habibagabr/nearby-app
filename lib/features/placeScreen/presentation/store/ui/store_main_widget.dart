...
import 'package:near_buy_gp/features/placeScreen/domain/entities/commonEntities/social_entity.dart';
import 'package:near_buy_gp/features/placeScreen/domain/entities/commonEntities/social_media_enum.dart';
    ...
    return BlocBuilder<PlaceBloc, PlaceState>(
      builder: (context, state) {
        ...
        final socialItems = [
          ...
          if(widget.storeEntity.place.email != null)
            SocialData(socialMedia: SocialMedia.email, link: widget.storeEntity.place.email!),
          if(widget.storeEntity.place.website != null)
            SocialData(socialMedia: SocialMedia.website, link: widget.storeEntity.place.website!),
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: PlaceDescriptionWidget(
                  ...
                  placeType: widget.storeEntity.place.type.replaceAll("_", " "),
